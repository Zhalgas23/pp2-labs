...
class coin(pygame.sprite.Sprite):
    def __init__(self, speed):
        ...
        self.speed = speed
        self.coin_images = {
            1: pygame.image.load('C:\pp_2_labs\lab8\images\coins\isaac penny.gif').convert_alpha(),
            2: pygame.image.load('C:\pp_2_labs\lab8\images\coins\isaac 1+1penny.gif').convert_alpha(),
            3: pygame.image.load('C:\pp_2_labs\lab8\images\coins\isaac nickel.gif').convert_alpha(),
            4: pygame.image.load('C:\pp_2_labs\lab8\images\coins\isaac dime.gif').convert_alpha()
        }
        self.image = pygame.transform.scale(self.coin_images[1], (30, 30))
        
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)

    def move(self):
        self.value = random.choice([1, 2, 3, 4])
        self.image = pygame.transform.scale(self.coin_images[self.value], (30, 30))
...
while running:
    ...
    if PLAYER.rect.colliderect(COIN.rect):
        cnt += COIN.value  # increment score by coin value
        COIN.reset_position()
